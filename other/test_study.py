...
from vzhuh.config import SeleniumAction  # импорт класса SeleniumAction из action.py
...
def browser():
    gecko_path = r"../config/webdrivers/geckodriver.exe"  # местоположение вебдрайвера (фаерфокс)
